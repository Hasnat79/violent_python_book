#!usr/bin/env python3
#port_scanner.py scans by host_name/ip and ports to scan open ports 
import argparse
import socket 
import threading
...
if __name__ == "__main__":
    parser=argparse.ArgumentParser(usage='port_scanner.py TARGET_HOST -p TARGET_PORTS'
        '\nexample: python3 port_scanner.py scanme.nmap.org -p 21,80')
